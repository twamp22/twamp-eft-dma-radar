...
namespace eft_dma_shared.Common.Misc
{
    ...
    public static class Extensions
    {
        ...
        #region Data Obfuscation

        /// <summary>
        /// Obfuscate an unsigned 64bit integer.
        /// </summary>
        ...
        public static ulong Obfuscate(this ulong num)
        {
            ...
            const ulong mask2 = 0xDBE1B885F68CD102;
            const ulong mask3 = 0x9ED77E12F16C163F;
            num ^= mask1;
            num ^= mask2;
            num ^= mask3;
            num = ~num;
        ...
        /// <summary>
        /// Deobfuscate an obfuscated unsigned 64bit integer.
        /// </summary>
        ...
        /// <summary>
        /// Obfuscate a signed 32bit integer.
        /// </summary>
        /// <param name="num">Integer to obfuscate</param>
        /// <returns>Obfuscated integer</returns>
        [Obfuscation(Feature = "Virtualization", Exclude = false)]
        ...
        /// <summary>
        /// Deobfuscate an obfuscated signed 32bit integer.
        /// </summary>
        /// <param name="num">Obfuscated integer.</param>
        /// <returns>Deobfuscated integer.</returns>
        [Obfuscation(Feature = "Virtualization", Exclude = false)]
